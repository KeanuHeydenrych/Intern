...
func main() {
	...
	*/
	...
	//1. create a pointer and show the adress
	x_point_1 := 5
	fmt.Println("Value:", x_point_1)
	fmt.Println("Pointer adress:", &x_point_1)

	//2. dereferencing an andress
	fmt.Println("\nvalue:", a, "\t Type: %T", a)
	fmt.Println("value:", b, "\t Type: %T", b)
	fmt.Println("value:", c, "\t Type: %T", c)
	fmt.Println("value:", d, "\t Type: %T", d)
...
func (d dog) walk() {
	fmt.Println("Name:", d.name, "and I am walking.")
}

func (d *dog) run() {
	d.name = "Ghoempie"
	fmt.Println("Name:", d.name, "and I am running.")
}
...
// This is reduntant, thus we use generics:
